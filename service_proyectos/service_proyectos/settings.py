...
SECRET_KEY = 'django-insecure-y@_lp%799au6jm@&za6!udu6m@e(gb7i$ojpg*cwjlgi#=&#bf'
...
ROOT_URLCONF = 'service_proyectos.urls'
...
WSGI_APPLICATION = 'service_proyectos.wsgi.application'
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': BASE_DIR / 'db.service_proyectos',
        }
    }
