...
SECRET_KEY = 'django-insecure-lw1=88q(^yd-wmhjq$c#0e@=r4#g_@-mlcs11k8u-w0nmn^s7='
...
ROOT_URLCONF = 'service_programacion.urls'
...
WSGI_APPLICATION = 'service_programacion.wsgi.application'
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': BASE_DIR / 'db.service_programacion',
        }
    }
